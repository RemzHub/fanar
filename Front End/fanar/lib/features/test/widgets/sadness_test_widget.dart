...
class SadnessTestWidget extends StatefulWidget {
  const SadnessTestWidget({super.key});

  @override
  State<SadnessTestWidget> createState() => _SadnessTestWidgetState();
}

class _SadnessTestWidgetState extends State<SadnessTestWidget> {
  String? audioPath;
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('كيف تُعبّر عن الحزن من خلال الصوت؟'),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'كنتِ هنا... والآن غيابك في كل مكان. الوقت قال لي إنه يداوي الجروح، لكن الجرح كبر.ضحكتك، صوتك، و كل شيء',
