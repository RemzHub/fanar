...
import 'package:fanar/features/auth/logic/model/profile.dart';
...
class RecruiterProfileWidget extends StatelessWidget {
  const RecruiterProfileWidget({super.key});
                        ...
                        Column(
                          children: [
                            ...
                            ProfileListTile(
                              ...
                              onTap: () => Get.toNamed(
                                  RecruiterEditProfileScreen.routeName),
                            ),
                            const SizedBox(height: 32.0),
                            ProfileListTile(
                              title: 'تسجيل خروج',
              ...
              children: [
                ...
                GetBuilder<AuthController>(
                  builder: (authController) {
                    final profile =
                        authController.user.profile as RecruiterProfile;
